      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{asset('AdminAssets/images/logo/logo.png')}}" alt=""><img class="img-fluid for-dark" src="=" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0">
                <div class="d-flex profile-media"><img class="b-r-10" src="{{asset('AdminAssets/images/dashboard/profile.png')}}" alt="">
                  <div class="flex-grow-1"><span>Syed Sabeer</span>
